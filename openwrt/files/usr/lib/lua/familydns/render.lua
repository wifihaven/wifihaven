...
-- populated out-of-band by the `familydns-dns-tail` sidecar, which already
...
function M.dnsmasq(snapshot)
  ...
  -- by the familydns-dns-tail sidecar from the dnsmasq query log instead.
  ...
  -- IT resolved"). familydns-dns-tail tails the dnsmasq query log and
