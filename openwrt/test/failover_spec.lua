...
describe("render.nft — #385/#422 three-mode failover", function()
  ...
  it("AllowAll: other profiles' drops are unaffected by AllowAll suppression", function()
    ...
    assert.truthy(nft:find(
      "ether saddr bb:bb:bb:00:00:02 ip daddr @eb_adultblocked_example counter drop comment \"wh_drop:bb:bb:bb:00:00:02:host:adultblocked.example\"",
      1, true))
    -- AllowAll guest does NOT have its extraBlocked drop.
    assert.is_nil(nft:find(
      "ether saddr cc:cc:cc:00:00:03 ip daddr @eb_guestblocked_example counter drop comment \"wh_drop:cc:cc:cc:00:00:03:host:guestblocked.example\"",
      1, true))
  end)
